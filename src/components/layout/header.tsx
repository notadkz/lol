...
export default function Header() {
  ...
  // Debug log khi component được render
  useEffect(() => {
    console.log("Header rendered", { isAuthenticated, pathname });
  }, [isAuthenticated, pathname]);

  // Debug log khi dropdown thay đổi
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    const handleClick = (e: MouseEvent) => {
      ...
      if (
        !target.closest("#header-avatar-dropdown") &&
        !target.closest("#header-avatar-btn")
      ) {
  ...
  return (
      ...
      <div className="container mx-auto flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center space-x-2">
          <svg
            ...
            x="0px"
            y="0px"
            viewBox="0 0 779.1 565.2"
            xmlSpace="preserve"
            className="size-28 dark:invert"
          >
            <path
              className="st0"
              d="M618.4,367.5c2.1,1.9,3.7,3.4,5.4,4.9c8.3,7.8,17.3,13.8,28.2,15.4c11,1.6,21.8,1.5,31.1-7
	...
	c-2-9.3-3.7-18.8-5.6-28.1C618.1,369.2,618.2,368.8,618.4,367.5z"
            ...
            <path
              className="st0"
              d="M178,402.8c2.2-2.8,4.2-5.7,6.6-8.4c0.7-0.8,2.2-0.8,3.4-0.8c48,0,96,0.1,144,0.3c12.2,0,24.3,0.1,36.5,0.9
	...
	c-30.4-0.1-60.9,0.1-91.3,0.1c-26.2-0.1-52.4-0.4-78.5-0.8c-4.9-0.1-9.8-0.8-14.7-1.3C178.1,403.5,178,403.1,178,402.8z"
            ...
            <path
              className="st0"
              d="M322.9,330.1c1.3-0.1,2-0.4,2.7-0.4c7.4,0,14.6,0,22,0c2,0,2.7,0.7,2.7,3.1c0,16.2,0,32.3,0,48.4
	...
	c4.1-0.1,8.2-1.2,12.3-1.6c2-0.3,2.6-1.3,2.5-3.5c0-8,0.1-16.1,0-24c0-1.5-0.7-3.2-1.5-4.5C328.1,336.7,325.6,333.6,322.9,330.1z"
            ...
            <path
              className="st0"
              d="M429.3,383.9c2.1-2,4.2-4.2,6.6-6.1c1.9-1.6,2.7-3.5,2.6-6.2c-0.1-26.5,0-52.8,0-79.2c0-2.7-0.7-4.7-2.5-6.3
	...
	c0,22.9,0,45.9,0,68.7c0,3-0.6,4-3.4,4c-6.1-0.3-12.3,0-18.4-0.1c-0.9,0-2-0.1-2.9-0.1C429.6,384.5,429.4,384.2,429.3,383.9z"
            ...
            <path
              className="st0"
              d="M531,383.4c7.3-8.2,7.4-18.2,7.4-28.2c0.1-16.2,0.1-32.3,0.1-48.4c0-15,0-15-7-26.9c0.9-0.1,1.6-0.3,2.5-0.3
	...
	c-6.2-1.5-12.8-1.2-19.1-1.9c-2.6-0.3-3.5,0.8-3.5,3.9C554.9,309.6,554.8,320.9,554.8,332.4z"
            ...
            <path
              className="st0"
              d="M104.3,408c3-4.3,5.6-8.2,8.4-11.7s3.7-7.3,3.7-12c-0.1-35.1,0-70.2,0.1-105.3c0-5.5-1.1-10.1-4.4-14
	...
	c-0.8,1.1-2.5,1.9-3.7,2c-19,0.3-38,0.3-57.1,0.3C106.5,408.4,105.8,408.2,104.3,408z"
            ...
            <path
              className="st0"
              d="M265.8,383.5c-26.3,0-52.7,0-79.7,0c2.7-3.2,4.9-6.1,7.3-8.6c1.6-1.8,2.3-3.8,2.3-6.5c0-24.2,0-48.4,0.1-72.6
	...
	c11.4,0,22.7,0.1,34.1,0c2.7,0,4.7,0.8,6.6,3.2c2.8,3.6,5.9,7.2,8.9,10.7C266.2,383,266,383.3,265.8,383.5z"
            ...
            <path
              className="st0"
              d="M454,212.3c1.2-0.3,1.9-0.4,2.6-0.4c6.1,0,12.3,0,18.4,0c2,0,2.7,0.8,2.7,3.1c-0.1,14.2,0,28.3,0,42.5
	...
	c0-1.5-1.1-3.1-1.9-4.3C458.1,217.4,456.1,215.1,454,212.3z"
            ...
            <path
              className="st0"
              d="M357.8,280c1.4-0.1,2.3-0.3,3.2-0.3c18.7,0,37.6,0,56.3,0c2.8,0,3.6,0.9,3.5,4.2c-0.2,5.9,0,12,0,17.9
	...
	c0-3.6-0.5-6.7-2.8-9.6C361.1,285.4,359.7,282.8,357.8,280z"
            ...
            <path
              className="st0"
              d="M97.6,252.6c2.7,3.9,4.9,7.2,7.1,10.4c-0.1,0.3-0.2,0.7-0.5,0.9c-3.3,0-6.4,0.1-9.7,0c-2,0-4-0.3-6-0.7
	...
	c-0.8,0.9-2.5,1.3-3.7,1.5c-7.4,0.1-14.9,0-22.2,0.1C104.5,252.1,101.5,252.3,97.6,252.6z"
            ...
            <path
              className="st0"
              d="M558.4,168.1c-0.6,0.9-0.8,1.3-1.1,1.6c-5,3.9-5.7,9.4-5.6,15.9c0.2,20.2,0.2,40.6,0,60.9c0,3.9,0.7,7,3.4,9.4
	...
	c0-2.8,0.7-3.6,3.2-3.6c4.7,0.1,9.4,0,14,0C556.1,167.9,556.9,168,558.4,168.1z"
            ...
            <path
              className="st0"
              d="M403,261.9c-6.3,0-12.5,0.1-18.8-0.1c-0.9,0-2.1-1.9-2.6-3.2c-3.4-9-6.7-18.1-9.7-27.3
	...
	c5.9,0,11.1,0,16.9,0C361.8,204.7,359.2,197,356.8,189.3z"
            ...
            <path
              className="st0"
              d="M250.7,260.4c1.6-1.5,3.5-2.7,4.8-4.6c1.2-1.8,2.3-4.2,2.3-6.3c0-21.7-0.1-43.5,0-65.2c0-5-0.8-8.9-4.3-11.9
	...
	c-0.2,0.5-1.2,0.9-1.9,0.9c-17.9,0-35.7,0-53.6,0c-0.5,0-0.8-0.3-1.3-0.4C251.2,261.3,250.9,260.9,250.7,260.4z"
            ...
            <path
              className="st0"
              d="M629.9,248.6c-3,4.2-6.1,8.4-9.2,12.4c-0.5,0.7-1.6,0.9-2.5,0.9c-16.4,0.1-32.8,0.1-49.2,0.1
	...
	c0,2.7,0.8,3.4,3,3.4c11.8-0.1,23.6,0,35.5,0c0.9,0,2,0.1,2.9,0.1C629.7,247.9,629.8,248.3,629.9,248.6z"
            ...
            <path
              className="st0"
              d="M677.3,182.2c-14.2,18.6-15.6,37.5-1.9,55.3c14.3,18.8,31.8,15.9,49.5,6.2c9,16.2-1.1,84.1-14.7,98.4
	...
	c0.1-9.9-0.9-8.1,6.8-8.2c12.2-0.1,24.3,0,36.5,0C674.3,182.2,675.4,182.2,677.3,182.2z"
            ...
            <path
              className="st0"
              d="M186.7,258.8c1.4-1.2,2.9-2.6,4.3-3.8c2.3-2.2,3.4-5,3.4-8.2c0-25.8,0-51.6-0.2-77.3c0-1.8-0.9-3.8-2-5.3
	...
	C187.3,259.8,187,259.2,186.7,258.8z"
            ...
            <path
              className="st0"
              d="M351.7,160.6c12.8-10,76.2-11.9,88.1-2.7c-1.2,0.3-2.1,0.4-3,0.7c-4.4,1.2-8.9,2.4-13.3,3.5
	...
	C360.6,160.6,356.4,160.6,351.7,160.6z"
            ...
            <path
              className="st0"
              d="M234,182.2c5,0,10.1,0,15.1,0c1.9,0,2.8,0.5,2.8,3c0.1,8.5,0.2,8.5-7.1,8.5c-8.5,0-17.1-0.1-25.5,0
	c-2.1,0-2.9-0.8-2.8-3.2c0.2-9.9-1.1-8,6.8-8.1C226.8,182,230.3,182.2,234,182.2z"
            />
            <path
              className="st0"
              d="M340.8,176.1c-1.6,1.1-3.2,1.9-4.4,2.8c-5.7,4.2-11.6,8.5-17.3,12.7c-0.7,0.5-1.3,1.2-2,1.6
	...
	C337.8,171.6,339.2,173.7,340.8,176.1z"
            ...
            <path
              className="st0"
              d="M518.7,193.5c-3.5,0-6.9,0-10.4,0c-1.6,0-2.3-0.7-2.3-2.6c0.1-10.9-1.1-8.6,7-8.9c5.1-0.1,10.4,0,15.6,0
	c1.9,0,2.6,0.7,2.6,3c0.2,8.5,0.2,8.5-7.3,8.5C522.1,193.5,520.4,193.5,518.7,193.5z"
            />
            <path
              className="st0"
              d="M631.2,212.9c4.8,0,8.1,4.3,8.1,10.5c0,6.3-3.5,10.1-9.2,10.3c-5.3,0.1-8.8-4.3-8.8-10.9
	...
	C632.8,228.5,634.5,226.3,634.5,223.2z"
            ...
            <path
              className="st0"
              d="M619.2,193.6c-1.9,0-3.7,0-5.5,0c-5.3,0-10.5,0-15.9,0c-1.9,0-3.2-0.5-3-3.2c0.1-2.4,1.2-3.2,3.2-3.2
	c4.9,0.1,9.8,0,14.7,0C615.8,187.2,617.9,189.3,619.2,193.6z"
            />
            <path
              className="st0"
              d="M563,193.5c-7-0.1-6.2,1.5-6.2-7.2c0-4.2,0-4.2,3.6-4.2c2,0,4,0.1,6.1,0c2.1-0.1,2.8,0.8,2.7,3.1
	c0,0.3,0,0.7,0,0.9C569.1,194.9,570.1,193.4,563,193.5z"
            />
            <path
              className="st0"
              d="M641.1,213.5c3.5,0,6.8-0.3,10,0.1c0.9,0.1,1.5,2.6,2.7,4.6c-2.5,0-4-0.1-5.5,0c-0.6,0-1,0.7-1.6,1.1
	...
	c0.1,1.6-0.4,2.6-2,2.4c-1.2-0.1-2.3,0-3.6,0C643.3,226.7,643.3,220.5,641.1,213.5z"
            ...
            <path
              className="st0"
              d="M682.1,363.4c2.1,3.2,2.2,6.5,0,9.2c-5.4,6.5-12.4,8.1-20,7.7c3.4-2.7,6.9-5.1,10.3-8
	C675.6,369.6,678.8,366.5,682.1,363.4z"
            />
            <path
              className="st0"
              d="M302.6,193.6c-2.6,0-4.6,0-6.6,0c-4.8,0-9.7,0-14.5,0c-1.4,0-2.9,0-2.8-2.3c0-2.2,1.4-2.4,2.9-2.4
	c5.3,0,10.5,0,15.8,0C299.9,188.9,301.2,190.5,302.6,193.6z"
            />
            <path
              className="st0"
              d="M481.3,190.5c-7.5-3.2-10.3-10.3-6.7-16.3C480.5,177.6,482.7,183,481.3,190.5z"
            />
            <path
              className="st0"
              d="M634.5,223.2c0,3.1-1.8,5.3-4.3,5.3s-4.3-2.2-4.3-5.3c0-3.2,1.9-5.5,4.4-5.5
        ...
        <nav className="hidden md:flex items-center space-x-8">
          {navItems.map((item, index) => (
            <Link
              ...
              href={item.href}
              className={cn(
                "nav-item text-sm font-medium transition-colors hover:dark:text-white hover:text-black",
                pathname === item.href
